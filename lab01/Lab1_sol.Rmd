...
Hello. My name is Tilman. Here is some text that I have written.
...
Here is a story.  If $x$ takes the value 5
```{r}
x <- 5
```
and $y$ takes the value -3
```{r}
y <- -3
```
...
x*y
```
Then $x$ and $y$ lived happily ever after. The end.
